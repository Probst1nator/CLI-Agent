            ...
            "code_examples": [
                {
                    ...
                    "code": """<python>
from utils.updatefile import UpdateFile
result = UpdateFile.run(
    path="config.json",
    edit_mode="overwrite",
...
def run(
    ...
    """
    Module-level wrapper for UpdateFile._run_logic() to maintain compatibility with CLI-Agent.
